...
\commenting{OLTC Transformer Class (needed interface / logable data, interface methods, and the abstract design)}
...
\commenting{
        ...
        Procedure:
        \begin{enumerate}
                \item Static solutions available for this scenario: The Load scenario can be stable, but dynamically maye not.
                \item OLTC can support, and really longer the time, the closer the solution is to the static grid solution
                \item Critical times for envelope violations
                \item Comparison of stability scenarios with envelopes
                \item Weak bus identification
        \end{enumerate}
        }
