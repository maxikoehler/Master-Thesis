...
\commenting{
        ...
        \end{enumerate}
        Important note on indices: 1 always LV side, 2 always HV side; $\vartheta$ is always on the HV side, meaning when relating the impedances to another side, the admittance matrix is differing. This is the difference between the Machowski and the Kundur / Milano approach. In the simulation tool, this has to be understood and implemented towards the correct side.
}
