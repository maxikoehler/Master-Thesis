...
\subsubsection{Single Machine Load Model}
...
To begin with the validation of the implemented control schemes, a basic strategy is accounted for all the considered models and verification setups.
