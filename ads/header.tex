...
\documentclass[%
    final,
  paper=297mm:210mm,			% Papierformat
...
%	topmargin = 10pt,	% Abstand Seitenrand (Std:1in) zu Kopfzeile [laut log: unused]
	...
	headinclude=true,	% Kopfzeile nicht in den Satzspiegel einbeziehen
	footinclude=true,	% Fußzeile nicht in den Satzspiegel einbeziehen
...
\usepackage[inner=2.5cm,outer=4.5cm,top=2.5cm,bottom=2.5cm,foot=.5cm,marginparwidth=3.2cm,marginparsep=.6cm]{geometry}	% Seitenränder und Abstände
...
\setsidenotes{
  ...
  text-format+={\RaggedRight\color{ees_blue}\itshape},%\RaggedRight
...
\usepackage[obeyFinal,backgroundcolor=ees_red!40,linecolor=ees_red, figwidth=.9\linewidth,figcolor=white,textwidth=3cm]{todonotes}
...
\ohead[]{\headmark}       		% Kopfzeile außen immer mit Headmark versehen
% \ihead[]{}       		% Kopfzeile außen immer mit Headmark versehen
